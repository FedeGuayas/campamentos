            ...
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    @if (Auth::check())
                        ...
                        <li><a class="dropdown-button waves-effect waves-light" href="#!" data-beloworigin="true" data-hover="true" data-constrainwidth="false"
                               data-activates="dropdownMenu">{{ Auth::user()->first_name }}<i class="material-icons right">arrow_drop_down</i><i class="fa fa-user left"></i></a>
                        </li>
                    @endif
                ...
                <ul id="slide-out" class="side-nav teal lighten-1">
                    ...
                    <li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            ...
                            @if (Auth::check())
                            <li>{{--Menu Acordion --}}
                                <a class="collapsible-header waves-effect waves-red">{{ Auth::user()->first_name }}<i class="material-icons right">arrow_drop_down</i><i class="fa fa-user left"></i></a>
