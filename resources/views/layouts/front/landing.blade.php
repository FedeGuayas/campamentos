    ...
    <div class="full-bg-img flex-center">
        <div class="container">
            ...
            @if (!Auth::check())
                ...
                @if(Auth::check())
                    <div class="col-sm-12">
                        <div class="description wow slideInDown">
                            <h2 class="h3-responsive">Bienvenid@   "{{Auth::user()->getNameAttribute()}}"</h2>
                            <p class="" data-wow-delay="0.4s">En su menú de usuario podra realizar las inscripciones, comentar sobre nuestros servicios
                                y modificar su perfil de usuario...</p>
                            <br>
