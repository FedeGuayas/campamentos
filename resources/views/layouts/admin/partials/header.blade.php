    ...
    <div class="navbar-fixed">
        <nav class="teal darken-1">
            ...
            <ul id="dropdownReportes" class="dropdown-content">
                ...
                <li><a href="{{route('admin.reports.personalizado')}}" class="waves-effect waves-teal">Personalizado</a>
                </li>
            ...
            <div class="nav-wrapper">
                ...
                <!-- Dropdown Inscripciones -->
                    <li>
                        <a class="dropdown-button waves-effect waves-light" href="#!" data-beloworigin="true"
                           data-hover="true" data-constrainwidth="false" data-activates="dropdownInsc">Inscripciones<i
                    ...
                    <li>
                        <a class="dropdown-button waves-effect waves-light" href="#!" data-beloworigin="true"
                           data-hover="true" data-constrainwidth="false" data-activates="dropdownProg">Programación<i
                                    class="fa fa-calendar left"></i><i class="fa fa-sort-down right"></i>
                        </a>
                    </li>
                    <!-- Dropdown Reportes -->
                    <li>
                        <a class="dropdown-button waves-effect waves-light" href="#!" data-beloworigin="true"
                           data-hover="true" data-constrainwidth="false" data-activates="dropdownReportes">Reportes<i
                                    class="fa fa-bar-chart-o left"></i><i class="fa fa-sort-down right"></i>
                        </a>
                    </li>
                    <!-- Dropdown Ajustes -->
                    @if (Entrust::hasRole(['administrator', 'planner']))
                        <li>
                            <a class="dropdown-button waves-effect waves-light" href="#!" data-beloworigin="true"
                               data-hover="true" data-constrainwidth="false" data-activates="dropdownConfig">Ajustes<i
                ...
                <!-- Dropdown Usuarios -->
                    <li>
                        <a class="dropdown-button waves-effect waves-light" href="#!" data-beloworigin="true"
                           ...
                           data-activates="dropdownUser">{{Auth::user()->first_name}}<i class="fa fa-user left"></i><i
                                    class="fa fa-sort-down right"></i>
                        </a>
                    </li>
                </ul>
                ...
                <ul id="slide-out" class="side-nav teal lighten-1">
                    ...
                    <li class="active">
                        <a href="#!" class="waves-effect waves-light"><i class="fa fa-2x fa-home"></i>
                        </a>
                    </li>
                    {{--<li><a href="#!" class="waves-effect waves-red"><i class="fa fa-2x fa-envelope"></i></a></li>--}}

                    <li>
                        <a href="{!! route('admin.inscripcions.reservas')!!}" class="waves-effect waves-red"><i
                                    class="fa fa-2x fa-bell-o"></i>Preinscripción<span class="badge red-text"
                        ...
                        <ul class="collapsible collapsible-accordion">
                            ...
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        <li>
                                            <a href="{!! route('admin.inscripcions.index') !!}"
                                               class="waves-effect waves-teal">Inscripciones</a>
                                        </li>
                                        <li class="divider"></li>
                                        @if (Entrust::can('create_inscripcion'))
                                            <li>
                                                <a href="{!! route('admin.inscripcions.create') !!}"
                                                   class="waves-effect waves-teal">Nueva</a>
                                            </li>
                                            <li class="divider"></li>
                                        @endif
                                        <li>
                                            <a href="{!! route('admin.alumnos.index') !!}"
                                               class="waves-effect waves-teal">Alumnos</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="{!! route('admin.representantes.index') !!}"
                                               class="waves-effect waves-teal">Representantes</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="{{route('admin.inscripcions.index.deletes')}}"
                                               class="waves-effect waves-teal">Eliminadas</a>
                                        </li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href=" {!! route('admin.modulos.index') !!}"
                                               class="waves-effect waves-teal">Modulos</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href=" {!! route('admin.programs.index') !!}"
                                               class="waves-effect waves-teal">Programa</a>
                                        </li>
                                        <li class="divider"></li>
                                        @endrole
                                        <li>
                                            <a href="{!! route('admin.calendars.index') !!}"
                                               class="waves-effect waves-teal">Cursos</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        <li>
                                            <a href="{{route('admin.facturas.index')}}" class="waves-effect waves-teal">Comprobantes</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="{{route('admin.pagos.cuadre')}}" class="waves-effect waves-teal">Cuadre
                                                Diario</a>
                                        </li>
                                        <li>
                                            <a href="{{route('admin.reports.factura')}}"
                                               class="waves-effect waves-teal">Facturación</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="{{route('admin.reports.excel')}}" class="waves-effect waves-teal">Período
                                                Insc.</a>
                                        </li>
                                        <li>
                                            <a href="{{route('admin.reports.personalizado')}}"
                                               class="waves-effect waves-teal">Personalizado</a>
                                        </li>
                                        <li>
                                            <a href="{{route('admin.reports.general')}}"
                                               class="waves-effect waves-teal">Listado</a>
                                        </li>
                                        <li>
                                            <a href="{{route('admin.reports.resumen')}}"
                                               class="waves-effect waves-teal">Inscritos - Recaudado</a>
                                        </li>
                                        {{--<li class="divider"></li>--}}
                                        {{--<li>--}}
                            ...
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        @if(Auth::user()->hasRole(['planner','administrator']))
                                            <li>
                                                <a href="#!" class="waves-effect waves-teal">Escenarios</a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#!" class="waves-effect waves-teal">Disciplinas</a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#!" class="waves-effect waves-teal">Horarios</a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#!" class="waves-effect waves-teal">Días</a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                            ...
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#!" class="waves-effect waves-teal">Encuestas</a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#!" class="waves-effect waves-teal">Transportes</a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#!" class="waves-effect waves-teal">Formas Pago</a>
                                            </li>
                                        @endif
                                        @role('administrator')
                                        <li>
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="#!" class="waves-effect waves-teal">Roles</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="#!" class="waves-effect waves-teal">Permisos</a>
                                        </li>
                                        @endrole
                                    </ul>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="{{url('/logout')}}" class="waves-effect waves-teal">Logout</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
