    ...
    <div class="navbar-fixed">
        <nav class="teal darken-1">
            ...
            <ul id="dropdownReportes" class="dropdown-content">
                ...
                <li><a href="{{route('admin.reports.resumen')}}" class="waves-effect waves-teal">Inscritos - Recaudados</a></li>
                <li class="divider"></li>
            ...
            <div class="nav-wrapper">
                    ...
                    <li>
                        <a href="{!! route('admin.inscripcions.reservas')!!}"
                           class="waves-effect waves-light"><i class="fa fa-bell-o left"></i>Preinscripción
                            <span class="badge red-text" data-badge-caption="">{{ Session::has('reservas') ?  Session::get('reservas') : ''}}</span>
                        </a>
                    </li>
                ...
                <!-- Dropdown Usuarios -->
                    <li>
                        <a class="dropdown-button waves-effect waves-light" href="#" data-beloworigin="true"
                           data-hover="true" data-constrainwidth="false" data-activates="dropdownUser">{{Auth::user()->first_name}}
                ...
                <ul id="slide-out" class="side-nav teal lighten-1">
                    ...
                    <li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            ...
                            <li>
                                <a class="collapsible-header waves-effect waves-red">Inscripciones<i class="fa fa-pencil"></i></a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="{!! route('admin.inscripcions.index') !!}" class="waves-effect waves-teal">Todas</a></li>
                                        <li class="divider"></li>
                                        @if (Entrust::can('create_inscripcion'))
                            ...
                            <li>
                                <a class="collapsible-header waves-effect waves-red">Clientes<i class="fa fa-pencil"></i></a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="{!! route('admin.alumnos.index') !!}" class="waves-effect waves-teal">Alumnos</a></li>
                                        <li class="divider"></li>
                            ...
                            <li>
                                @if (Entrust::hasRole(['administrator', 'planner']))
                                    <a class="collapsible-header waves-effect waves-red">Ajustes<i class="fa fa-gears"></i></a>
                                @endif
                                <div class="collapsible-body">
                                    <ul>
                                        @if(Auth::user()->hasRole(['planner','administrator']))
