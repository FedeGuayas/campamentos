...
<footer class="page-footer center-on-small-only teal darken-4">
    ...
    <div class="call-to-action">
        ...
        <ul>
            ...
            <li>
                <h5>Inscribase en nuestros campamentos</h5></li>
            <li><a href="" class="btn btn-default">Inscribirse!</a>
            </li>
            <li><a href="" class="btn btn-danger">Salir</a></li>
        </ul>
    </div>
    <!--/.Call to action-->
