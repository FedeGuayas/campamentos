...
@section('title', 'Editar Tipo Descuento')
    ...
    <div class="row">
        <div class="col l8 m12 s12">
            ...
            <div class="card-panel">
                <h5 class="header teal-text text-darken-2">Editar Descuento</h5>
                <div class="card-content ">
                    {!! Form::model($descuento,['route'=>['admin.tipo_descuentos.update',$descuento->id], 'method'=>'PUT'])  !!}
                    <div class="col s12">
