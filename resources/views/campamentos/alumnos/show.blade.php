        ...
        <div class="col l6 offset-l1 m6 s12">
            ...
            <div class="card sticky-action hoverable">
                <div class="card-image waves-effect waves-block waves-light">
                    <img class="responsive-img activator" src="{{ asset('dist/img/representantes/perfil/'.$representante->foto)}}" style='max-width: 70%'>
                </div>
                ...
                <div class="card-content">
                    ...
                    <p>aki un enlace a los alumnos de esta persona</p>
                </div>
