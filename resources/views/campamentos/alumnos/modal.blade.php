    <div id="modal-delete-{{ $al->id }}" class="modal modal-fixed-footer" style="height: 45%">
        {!! Form::open(['route'=>['admin.alumnos.destroy',$al->id],'method'=>'delete']) !!}
        <div class="modal-content">
            <div>
                 <h3>Eliminar Alumno<i class="fa fa-warning waves-red darken-4 materialize-red-text right medium"></i></h3>
            </div>
            <p >Confirme si desea eliminar al alumno <strong> {{$al->persona->getNombreAttribute()}}</strong></p>
