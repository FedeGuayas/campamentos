...
<table>
    ...
    @foreach ($cursos as $curso)
        <tr>
            ...
            <td>
                @if ( (($curso->cupos - $curso->contador)>0) && ($costo == $curso->mensualidad) && ($edad>=$curso->init_age && $edad<=$curso->end_age) && (Auth::user()->hasRole(['planner','administrator','supervisor','signup'])))
                    <a href="{{ route('admin.re_inscripcions.curso.store', [$inscripcion_id,$curso ]) }}">
