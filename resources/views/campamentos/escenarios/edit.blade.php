    ...
    <div class="row">
        <div class="col l8 m12 s12">
            <div class="card-panel">
                <h5 class="header teal-text text-darken-2">Editar Escenario</h5>
                <div class="card-content ">
                    @include('alert.success')
                    {!! Form::model($escenario,['route'=>['admin.escenarios.update',$escenario->id], 'method'=>'PUT'])  !!}
                    <div class="col s12">

                        <div class="input-field col s12 ">
                            {!! Form::label('escenario','Escenario:') !!}
                            {!! Form::text('escenario',null,['class'=>'validate']) !!}
                        </div>
